...
const Navbar = () => {
	...
	return (
		<nav className="h-[70px] fixed top-0 left-0 bg-[--bg1] w-full flex items-center shadow-[--shadow] shadow-md">
			<div className="container flex justify-between items-center">
				<button
					type="button"
					onClick={toggleShowNetworksPopup}
					className="flex gap-2 items-center rounded-3xl bg-[--brand] px-3 py-2"
				>
